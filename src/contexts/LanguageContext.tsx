...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'newsDetail.publish': 'Publish Article',
    ...
    'newsDetail.publishedSuccess': 'News article published successfully!',
    'newsDetail.publishError': 'Failed to publish news article. Please try again.',
  ...
  th: {
    ...
    'newsDetail.publish': 'เผยแพร่บทความ',
    ...
    'newsDetail.publishedSuccess': 'เผยแพร่บทความข่าวสำเร็จ!',
    'newsDetail.publishError': 'เผยแพร่บทความข่าวไม่สำเร็จ กรุณาลองอีกครั้ง',
    ...
    'verification.confirmVerify': 'ยืนยันการตรวจสอบ',
